...
const _addConservationAction = async (): Promise<[ResultSetHeader, FieldPacket[]]> => {return}

const _editConservationAction = async (id: number): Promise<[ResultSetHeader, FieldPacket[]]> => {return}
